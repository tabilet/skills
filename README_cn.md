...
这份中文文档是给中文开发者阅读的说明文档。仓库中的 harness 示例文件，例如 `AGENTS.md`、`memory-bank/*`、`evolution/*` 和 `.codex/prompts/*`，默认仍然使用英文，适合开发者用英文和 agent 沟通。

如果你希望用中文和 agent 对话，需要自己把这些 harness 文件翻译成中文，并保持文件之间的规则、状态标记、命令和路径一致。
