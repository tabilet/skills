...
Die drei Slash-Befehle liegen in [harness/skills/](harness/skills/). Claude Code und Codex lesen dasselbe `SKILL.md`-Format, es gibt also eine Quelle pro Befehl:
